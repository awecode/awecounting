...
web_urls = [
    ...
    url(r'^cash_receipt/list/$', views.CreditVoucherList.as_view(), name='credit_voucher_list'),
    url(r'^cash_receipt/create/$', views.CreditVoucherCreate.as_view(), name='credit_voucher_add'),
    url(r'^cash_receipt/(?P<pk>[0-9]+)/$', views.CreditVoucherUpdate.as_view(), name='credit_voucher_edit'),
    url(r'^cash-receipt/save/$', views.save_cash_receipt, name='credit_voucher_save'),
    url(r'^cash_receipt/detail/(?P<pk>[0-9]+)/$', views.CreditVoucherDetailView.as_view(), name='credit_voucher_detail'),

    url(r'^cash_payment/list/$', views.DebitVoucherList.as_view(), name='debit_voucher_list'),
    url(r'^cash_payment/create/$', views.DebitVoucherCreate.as_view(), name='debit_voucher_add'),
    url(r'^cash_payment/(?P<pk>[0-9]+)/$', views.DebitVoucherUpdate.as_view(), name='debit_voucher_edit'),
    url(r'^cash_payment/save/$', views.save_cash_payment, name='debit_voucher_save'),
    url(r'^cash_payment/detail/(?P<pk>[0-9]+)/$', views.DebitVoucherDetailView.as_view(), name='debit_voucher_detail'),
