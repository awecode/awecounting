...
web_urls = [
    ...
    url(r'^credit_voucher/list/$', views.CreditVoucherList.as_view(), name='credit_voucher_list'),
    url(r'^credit_voucher/create/$', views.CreditVoucherCreate.as_view(), name='credit_voucher_add'),
    url(r'^credit_voucher/(?P<pk>[0-9]+)/$', views.CreditVoucherUpdate.as_view(), name='credit_voucher_edit'),
    url(r'^cash_voucher/save/$', views.save_credit_voucher, name='credit_voucher_save'),
    url(r'^credit_voucher/detail/(?P<pk>[0-9]+)/$', views.CreditVoucherDetailView.as_view(), name='credit_voucher_detail'),

    url(r'^debit_voucher/list/$', views.DebitVoucherList.as_view(), name='debit_voucher_list'),
    url(r'^debit_voucher/create/$', views.DebitVoucherCreate.as_view(), name='debit_voucher_add'),
    url(r'^debit_voucher/(?P<pk>[0-9]+)/$', views.DebitVoucherUpdate.as_view(), name='debit_voucher_edit'),
    url(r'^debit_voucher/save/$', views.save_debit_voucher, name='debit_voucher_save'),
    url(r'^debit_voucher/detail/(?P<pk>[0-9]+)/$', views.DebitVoucherDetailView.as_view(), name='debit_voucher_detail'),
...
api_urls = [
    ...
    url(r'^api/debit_vouchers/', api.DebitVoucherListAPI.as_view()),
    url(r'^api/debit_voucher/(?P<pk>[0-9]+)/', api.DebitVoucherDetailAPI.as_view()),
    url(r'^api/credit_vouchers/', api.CreditVoucherListAPI.as_view()),
    url(r'^api/credit_voucher/(?P<pk>[0-9]+)/', api.CreditVoucherDetailAPI.as_view()),
